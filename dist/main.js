...
var Trait = function () {
  ...
  _createClass(Trait, [{
    ...
    key: 'trigger',
    value: function trigger(entity, arg) {}
  }, {
    key: 'update',
...
function useFetch(obj) {
  ...
  return fetch(url, Object.assign(entete, opt)).then(function (result) {
    return result.json();
  });
}
...
function getQueryString(object) {
  return Object.keys(object).map(function (item) {
    return typeof object[item] == "string" ? [encodeURIComponent(item), '=', encodeURIComponent(object[item])].join('') : [encodeURIComponent(item), '=', encodeURIComponent(JSON.stringify(object[item]))].join('');
  }).join('&');
}
...
exports.intersectSegment = intersectSegment;
...
function intersectSegment(oSeg1, oSeg2) {

  var Ax = oSeg1.point1.x,
      Ay = oSeg1.point1.y,
      Bx = oSeg1.point2.x,
      By = oSeg1.point2.y;

  var Cx = oSeg2.point1.x,
      Cy = oSeg2.point1.y,
      Dx = oSeg2.point2.x,
      Dy = oSeg2.point2.y;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(65), __webpack_require__(335)))
...
(function (global) {
    ...
    var Sharing = function Sharing(aElement, sEvent) {
        ...
        function _launch() {
            ...
            _aElement.map(function (oElement) {
                ...
                sUrlResult = sUrl.replace('[TEXT]', sText).replace('[URL]', sUrlEncode);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _factory.createLevel)(CONF.gamePath + 'dist/' + CONF.mode + '.json', { width: layer1.width, height: layer1.height, onReady: onReady });

          case 2:
            level = _context.sent;


            timer = new _timer2.default(freq);

            if (level.conf.debug) {

              level.render.pushOnLayer('layer2', (0, _debug.drawGrid)(level.conf, { width: layer1.width, height: layer1.height }));
              level.render.pushOnLayer('layer2', (0, _debug.colliderView)(level.entities));
              level.render.pushOnLayer('layer2', (0, _debug.snapCollider)(level.entities));
              level.render.pushOnLayer('layer2', (0, _debug.colliderBarre)(level.entities));
            }

            input = (0, _input.setupKeyboard)(level.entities);
            ...
            timer.draw = function (deltaTime) {
              level.render.draw(deltaTime);
            };

            timer.update = function (freq) {
            ...
            level.event.on('level.died', function () {
              playing = false;
              timer.stop();
              level.reset();
            });
...
var _factory = __webpack_require__(341);

var _input = __webpack_require__(358);

var _debug = __webpack_require__(360);
...
function onReady(level) {
  ...
  level.render.addLayer('layer2', ctx2, function (width, height) {
    return function (context, deltaTime) {
...
var Timer = function () {
  function Timer() {
    ...
    var frequence = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1 / 60;
    ...
    this.proxyRun = function (time) {

      if (_this.lastTick != 0) {

        _this.cumulateTime += (time - _this.lastTick || 0) / 1000;

        if (_this.cumulateTime > 1) {
          _this.cumulateTime = 1;
        }

        while (_this.cumulateTime > frequence) {
          _this.update(frequence);
          _this.cumulateTime -= frequence;
        }
      }
      ...
      if (_this.visibilityState == "visible") {
        _this.draw(_this.cumulateTime);
      }

      _this.play && _this.enqueue();
    };
  }
...
var _worlddata = __webpack_require__(342);

var _destructible = __webpack_require__(343);

var _balls = __webpack_require__(346);

var _barre = __webpack_require__(350);

var _level = __webpack_require__(353);

var _level2 = _interopRequireDefault(_level);

var _spritesheet = __webpack_require__(357);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function createLevel(pathName, _ref) {
  var width = _ref.width,
      height = _ref.height,
      onReady = _ref.onReady;


  return (0, _loader.loadJson)(pathName).then(function (conf) {
    return Promise.all([conf, (0, _loader.loadImage)(conf.destroyImage), (0, _loader.loadImage)(conf.crashImage)]);
  }).then(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 3),
        conf = _ref3[0],
        destroyImage = _ref3[1],
        crashImage = _ref3[2];

    return Promise.all([conf, destroyImage, (0, _spritesheet.createSprite)(crashImage), (0, _worlddata.createDataWorld)(destroyImage, {
      width: width,
    ...
    var _ref5 = _slicedToArray(_ref4, 4),
        conf = _ref5[0],
        destroyImage = _ref5[1],
        getCrash = _ref5[2],
        dataWorld = _ref5[3];

    var level = new _level2.default({ width: width, height: height });
    level.time = conf.time;
    level.palier = conf.palier;

    var factoryDestruct = (0, _destructible.createDestructible)(conf, dataWorld, getCrash);
    var factoryBall = (0, _balls.createBall)(conf, { width: width, height: height });

    var factoryBarre = (0, _barre.createBarre)(conf, { widthScene: width, heightScene: height });

    onReady(level);

    var destruct = factoryDestruct(level.event);
    ...
    conf.barre.map(function (obj) {
      var barre = factoryBarre(obj, level.event);
      level.entities.push(barre);
      level.render.pushOnLayer('layer2', barre.draw);
    });

    conf.balls.map(function (obj) {

      var ball = factoryBall(obj, level.event);
...
exports.createDataWorld = createDataWorld;

var _math = __webpack_require__(129);

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

function createDataWorld(image, _ref) {
  var analyse = function () {
    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref3) {
      ...
      var _getData2, data, width, height, buffer, mapW, mapH, mapLen;

      return regeneratorRuntime.wrap(function _callee$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _getData2 = _getData(zoom), data = _getData2.data, width = _getData2.width, height = _getData2.height, buffer = _getData2.buffer;
              mapW = Math.ceil(width / resolution), mapH = Math.ceil(height / resolution), mapLen = mapW * mapH + 1;
              return _context2.abrupt('return', new Promise(function (resolve) {

                for (; mapLen--;) {
                  var _indexToXY = (0, _math.indexToXY)(mapLen, mapW),
                      _indexToXY2 = _slicedToArray(_indexToXY, 2),
                      _x = _indexToXY2[0],
                      _y = _indexToXY2[1];

                  var pos = { x: _x * resolution, y: _y * resolution },
                      name = pos.x + ' ' + pos.y;
                  _coordinate.set(name, []);
                }

                resolve({ width: width, height: height, buffer: buffer });
              }).then(function (_ref4) {
                ...
                for (var i = 0; i < data.length; i++) {
                  var num = data[i],
                      _indexToXY3 = (0, _math.indexToXY)(num, width),
                  ...
                  if (_coordinate.has(name)) {
                    total++;
                    _coordinate.get(name).push({ x: x, y: y, died: false, color: '#FFF' });
                  }
                }
                ...
                return {
                  ...
                  getCell: function getCell(pos) {
                    var name = pos.x + ' ' + pos.y;
                  ...
                  getCellList: function getCellList(posList) {
                    var _this = this;

                    var pixelList = posList.map(function (pos) {
                      return _this.getCell(pos);
                    });
                    return posList.length ? pixelList : [];
                  },

                  getCoordonate: regeneratorRuntime.mark(function getCoordonate() {
                    var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, name, particules;

                    return regeneratorRuntime.wrap(function getCoordonate$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.prev = 3;
                            _iterator = this.coordinate[Symbol.iterator]();
                          ...
                          case 5:
                            ...
                            _step$value = _slicedToArray(_step.value, 2), name = _step$value[0], particules = _step$value[1];
                            ...
                            return _context.delegateYield(particules, 't0', 9);
                    ...
                    }, getCoordonate, this, [[3, 14, 18, 26], [19,, 21, 25]]);
                  })
                };
              }));
    ...
    return function analyse(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();

  var _ref$width = _ref.width,
      width = _ref$width === undefined ? 468 : _ref$width,
      _ref$resolution = _ref.resolution,
      resolution = _ref$resolution === undefined ? 30 : _ref$resolution,
      _ref$dpi = _ref.dpi,
      dpi = _ref$dpi === undefined ? 1 : _ref$dpi;
  ...
  function _getData(zoom) {
    ...
    context.drawImage(_image, 0, 0, _image.width, _image.height, 0, 0, buffer.width, buffer.height);

    var pixel = context.getImageData(0, 0, buffer.width, buffer.height).data,
        len = pixel.length;
    var i = 0,
        j = 0;
  ...
  return analyse({ zoom: width / _image.width, resolution: resolution, dpi: dpi });
};
...
exports.createDestructible = createDestructible;

var _destructible = __webpack_require__(344);

var _destructible2 = _interopRequireDefault(_destructible);

var _trait = __webpack_require__(43);

var _trait2 = _interopRequireDefault(_trait);

var _destroy = __webpack_require__(345);
...
var Hit = function (_Trait) {
  _inherits(Hit, _Trait);

  function Hit(subject, conf) {
    _classCallCheck(this, Hit);

    var _this = _possibleConstructorReturn(this, (Hit.__proto__ || Object.getPrototypeOf(Hit)).call(this, 'hit'));

    _this.subject = subject;
    _this.debug = conf.debug;
    return _this;
  }

  _createClass(Hit, [{
    key: "distance",
    value: function distance(pointSub, pointCandi) {
      var x = Math.abs(pointSub.x - pointCandi.x);
      var y = Math.abs(pointSub.y - pointCandi.y);
      return Math.sqrt(x * x + y * y);
    }
  }, {
    key: "trigger",
    value: function trigger(candidate) {
      var _this2 = this;
      ...
      pixelList.map(function (pixel, index) {

        if (pixel.length) {

          for (var i = 0; i < pixel.length; i++) {

            var distance = _this2.distance(currentPos, pixel[i]);
          ...
          if (update) {
            ...
            _this2.subject.event.emit('destructible.collide', [_this2.subject.currentPixel / _this2.subject.totalPixel, _this2.subject.currentPixel, _this2.subject.totalPixel]);

            _this2.subject.pushPiece(posList[index]);
          }
        }
      });

      if (pixelCollider.length >= 2) {
        var _getCouple = this.getCouple(pixelCollider),
            _getCouple2 = _slicedToArray(_getCouple, 2),
            vec1 = _getCouple2[0],
            vec2 = _getCouple2[1];

        var vector = new _vector2.default(vec1.x, vec1.y);

        vector.sub(new _vector2.default(vec2.x, vec2.y));

        var vectPer = new _vector2.default(-vector.y, vector.x);
    ...
    key: "getCouple",
    value: function getCouple(pixelCollider) {
      var _this3 = this;

      var coupleDist = [],
          calculated = [];

      pixelCollider.map(function (current) {

        for (var i = 0; i < pixelCollider.length; i++) {

          if (current == pixelCollider[i]) {
            continue;
          }

          var couple = [current, pixelCollider[i]];
          couple.sort(function (a, b) {
            b.x - a.x;
          });

          var name = JSON.stringify(couple);

          if (!~calculated.indexOf(name)) {
            var distance = _this3.distance(current, pixelCollider[i]);
...
function createDestructible(conf, dataWorld, getCrash) {
  ...
  return function destructibleElement(event) {
    ...
    var oDestructible = new _destructible2.default({ dpi: conf.setting.dpi, resolution: conf.setting.resolution });
    ...
    oDestructible.addTrait(new _destroy2.default());
...
var _boundingbox = __webpack_require__(93);
...
var Destructible = function () {
  function Destructible(_ref) {
    ...
    this.pos = new _vector2.default(0, 0);
    this.lifeTime = 0;
    this.dataWorld = {};
    this.traits = [];
    ...
    this.size = new _vector2.default(0, 0);
    ...
    this.bound = new _boundingbox2.default(this.pos, this.size, this.offset);
  ...
  _createClass(Destructible, [{
    ...
    key: 'pushPiece',
    value: function pushPiece(pos) {
      this.pieces.push(pos);
    }
  }, {
    key: 'drawPixel',
    value: function drawPixel(context, died, x, y, color) {
    ...
    key: 'reDrawingBuffer',
    value: function reDrawingBuffer() {
      var _this = this;
      ...
      this.pieces.map(function (pos) {
        var buffer = _this._updatePiece(pos);
        _this.context.drawImage(buffer, pos.x, pos.y);
      });
    ...
    value: function drawCrash() {
      ...
      this.pieces.map(function (pos) {
        ...
        var pixel = _this2.dataWorld.getCell(pos);
        ...
        for (var i = 0; i < pixel.length; i++) {
          ...
          if (pixel[i].died) {
            ...
            if (_this2.bufferCrash) {
              context.drawImage(_this2.bufferCrash, _x - 3, _y - 3);
            }
          }
        }
      });
    ...
    key: '_updatePiece',
    value: function _updatePiece(pos) {
      ...
      for (var i = 0; i < pixel.length; i++) {
        ...
        var _x = pixel[i].x - pos.x;
        var _y = pixel[i].y - pos.y;
    ...
    value: function resetBuffer() {
      ...
      try {
        for (var _iterator = this.dataWorld.getCoordonate()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function updateBuffer() {
      ...
      try {
        for (var _iterator2 = this.dataWorld.getCoordonate()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var Destroy = function (_Trait) {
  _inherits(Destroy, _Trait);

  function Destroy() {
    _classCallCheck(this, Destroy);

    return _possibleConstructorReturn(this, (Destroy.__proto__ || Object.getPrototypeOf(Destroy)).call(this, 'destroy'));
  }
...
var _ball = __webpack_require__(347);

var _ball2 = _interopRequireDefault(_ball);

var _mover = __webpack_require__(348);

var _mover2 = _interopRequireDefault(_mover);

var _bounce = __webpack_require__(349);
...
function createBall(conf, _ref) {
  var width = _ref.width,
      height = _ref.height;


  function randomPos() {
    var partHeight = height / 4;
    return {
  ...
  return function ballElement(_ref2, event) {
    var size = _ref2.size;


    var ball = new _ball2.default(Object.assign(randomPos(), { size: size }));

    var y = Math.random() * -1;
    var x = Math.random() * 2 - 1;

    ball.addTrait(new _mover2.default(x, y));
    ball.addTrait(new _bounce2.default({ width: width, height: height }));
...
var Ball = function () {
  function Ball(_ref) {
    ...
    this.size = new _vector2.default(size * 2, size * 2);
    this.radius = Math.round(size);
    this.width = size * 2;
    this.offset = new _vector2.default(-size, -size);
    this.bound = new _boundingbox2.default(this.pos, this.size, this.offset);
  ...
  _createClass(Ball, [{
    ...
    value: function getSegment() {
      var x1 = this.bound.left;
      var y1 = this.bound.top;

      var x2 = this.bound.right;
      var y2 = y1;

      var x3 = x2;
      var y3 = this.bound.bottom;

      var x4 = x1;
      var y4 = y3;

      return [{ point1: { x: x1, y: y1 }, point2: { x: x2, y: y2 } }, { point1: { x: x2, y: y2 }, point2: { x: x3, y: y3 } }, { point1: { x: x3, y: y3 }, point2: { x: x4, y: y4 } }, { point1: { x: x4, y: y4 }, point2: { x: x1, y: y1 } }];
    }
  }, {
    key: "finalize",
    value: function finalize() {
    ...
    key: "update",
    value: function update(freq) {
      var _this = this;

      this.traits.map(function (trait) {
        trait.update(_this, freq);
      });
    }
  }]);
...
var Mover = function (_Trait) {
  _inherits(Mover, _Trait);

  function Mover(x, y) {
    _classCallCheck(this, Mover);

    var _this = _possibleConstructorReturn(this, (Mover.__proto__ || Object.getPrototypeOf(Mover)).call(this, 'mover'));

    _this.x = x;
    _this.y = y;
    _this.vel = new _vector2.default(x, y);

    _this.vel.magnetude = 450;

    _this.lastVel = _this.vel.copy();

    _this.min = _this.vel.magnetude;
    _this.max = _this.vel.magnetude * 2;

    _this.gravity = new _vector2.default(0, 3);
    return _this;
  }
  ...
  _createClass(Mover, [{
    ...
    value: function reset() {
      this.vel = new _vector2.default(this.x, this.y);
    }
  }, {
    key: "snapPos",
    value: function snapPos(entity) {
      var posList = [],
          lib = [];

      var x1 = Math.floor(entity.bound.left / entity.grid) * entity.grid;
      var y1 = Math.floor(entity.bound.top / entity.grid) * entity.grid;
      var obj = { x: x1, y: y1 };
      var ref = "" + obj.x + obj.y;
      ...
      var x2 = Math.floor(entity.bound.right / entity.grid) * entity.grid;
      var y2 = y1;
      obj = { x: x2, y: y2 };
      ref = "" + obj.x + obj.y;
      ...
      var x3 = x2;
      var y3 = Math.floor(entity.bound.bottom / entity.grid) * entity.grid;
      obj = { x: x3, y: y3 };
      ref = "" + obj.x + obj.y;
    ...
    key: "update",
    value: function update(entity, freq) {
...
var Bounce = function (_Trait) {
  _inherits(Bounce, _Trait);

  function Bounce(_ref) {
    var width = _ref.width,
        height = _ref.height;

    _classCallCheck(this, Bounce);

    var _this = _possibleConstructorReturn(this, (Bounce.__proto__ || Object.getPrototypeOf(Bounce)).call(this, 'bounce'));
  ...
  _createClass(Bounce, [{
    ...
    key: "oppositeVel",
    value: function oppositeVel(entity, candidat) {
    ...
    key: "collide",
    value: function collide(entity, candidat) {
      var len = candidat.radius + entity.radius;
...
exports.createBarre = createBarre;

var _trait = __webpack_require__(43);

var _trait2 = _interopRequireDefault(_trait);

var _barre = __webpack_require__(351);
...
var _rotate = __webpack_require__(352);
...
var Hit = function (_Trait) {
  ...
  _createClass(Hit, [{
    ...
    value: function trigger(candidate) {
      ...
      var segments = candidate.getSegment(),
      ...
      for (var i = 0; i < len; i++) {
        for (var j = 0; j < lenSeg; j++) {
          ...
          if ((0, _math.intersectSegment)(segments[i], segmentSubject[j])) {
            ...
            var vector = new _vector2.default(-y, x);
...
function createBarre(conf, _ref) {
  var widthScene = _ref.widthScene,
      heightScene = _ref.heightScene;
  ...
  return function barreElement(_ref2, event) {
    ...
    var barre = new _barre2.default({ width: width, height: height, x: x, y: y, angle: angle }, { widthScene: widthScene, heightScene: heightScene });

    barre.event = event;
    barre.middleHeight = Math.round(height / 2);

    barre.addTrait(new Hit(barre));
    barre.addTrait(new _rotate2.default(angle));
...
var Barre = function () {
  function Barre(_ref, _ref2) {
    var width = _ref.width,
        height = _ref.height,
        x = _ref.x,
        y = _ref.y,
        angle = _ref.angle;
    var widthScene = _ref2.widthScene,
        heightScene = _ref2.heightScene;

    _classCallCheck(this, Barre);

    var middleHeight = Math.round(height / 2);
    var stepSegment = 6;

    this.TO_RADIAN = -(Math.PI / 180);
    this.traits = [];
    this.pos = new _vector2.default(x, y);
    this.size = new _vector2.default(width, height);
    this.sizeBound = new _vector2.default(width, heightScene - y);
    ...
    if (this.pos.x > widthScene / 2) {
      this.side = 'left';
      this.offset = new _vector2.default(-width, Math.round(height / -2));
      this.angleAdjust = -1;
    } else {
      this.side = 'right';
      this.offset = new _vector2.default(0, Math.round(height / -2));
    }

    for (var i = -middleHeight; i <= middleHeight; i += stepSegment) {
      this.buildSegment(x, y + i);
    }

    this.angle = angle;
    this.bound = new _boundingbox2.default(this.pos, this.sizeBound, this.offset);
  }

  _createClass(Barre, [{
    key: "buildSegment",
    value: function buildSegment(XOrig, YOrig) {

      var x = this.side == 'left' ? XOrig - this.size.x : XOrig + this.size.x;
      var y = YOrig;

      var point1 = new _vector2.default(XOrig, YOrig);
      var point2 = new _vector2.default(x, y);

      this.segment.push({ point1: point1, point2: point2 });
    }
  }, {
    key: "finalize",
    value: function finalize() {
    ...
    set: function set(angle) {
      ...
      var x = Math.sin(angle * this.TO_RADIAN) * this.size.x;
      var y = Math.cos(angle * this.TO_RADIAN) * this.size.x;

      if (this.side == 'right') {

        this.segment.map(function (seg) {
          seg.point2 = seg.point1.copy().add(new _vector2.default(x, y));
        });
      } else {
        this.segment.map(function (seg) {
          seg.point2 = seg.point1.copy().sub(new _vector2.default(x, y));
        });
      }
    }
  }]);
...
var Rotate = function (_Trait) {
  _inherits(Rotate, _Trait);

  function Rotate(angle) {
    _classCallCheck(this, Rotate);

    var _this = _possibleConstructorReturn(this, (Rotate.__proto__ || Object.getPrototypeOf(Rotate)).call(this, 'rotate'));

    _this.amplitudeMax = angle;
    _this.timeLife = 0;
...
var _render = __webpack_require__(354);

var _render2 = _interopRequireDefault(_render);

var _collider = __webpack_require__(355);

var _event = __webpack_require__(356);
...
var Level = function () {
  function Level(_ref) {
    var _ref$width = _ref.width,
        width = _ref$width === undefined ? 720 : _ref$width,
        _ref$height = _ref.height,
        height = _ref$height === undefined ? 480 : _ref$height;

    _classCallCheck(this, Level);

    this.render = (0, _render2.default)({ width: width, height: height });
    this.dataWorld = {};
    this.entities = [];
    this.conf = {};
    ...
    this.entityCollider = new _collider.EntityCollider(this.entities);
  ...
  _createClass(Level, [{
    key: 'onDestructibleCollide',
    value: function onDestructibleCollide(_ref2) {
      var _ref3 = _slicedToArray(_ref2, 1),
          por = _ref3[0];

      var collide = Math.round(por * 100);
    ...
    key: 'validScore',
    value: function validScore(_score) {
      return true;
    }
  }, {
    key: 'getToken',
    value: function getToken(_score) {
      ...
      return this.validScore(_score) ? sMessage.toString() : sTmpMessage.toString();
    }
  }, {
    key: 'send',
    value: function send(formData) {
      ...
      return Promise.resolve({
        ...
        _this.event.emit('level.sending', obj);
      });
    }
  }, {
    key: 'onBallDied',
    value: function onBallDied() {
      this.life--;
    ...
    value: function update(freq) {
      ...
      this.entities.map(function (entity) {
        _this2.entityCollider.check(entity);
      });
...
function Render(_ref) {
  ...
  function addLayer(name, context) {
    var initCall = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {};
  ...
  function drawOnce(name, funcDraw) {
    if (board.has(name)) {
      var _board$get = board.get(name),
          context = _board$get.context;
...
var Event = function Event() {
  ...
  function emit(eventName) {
    ...
    if (eventList.has(eventName)) {
      eventList.get(eventName).map(function (_ref) {
  ...
  function on(eventName, callback) {
    ...
    if (eventList.has(eventName)) {
      eventList.get(eventName).push({ callback: callback, scope: scope });
    } else {
      eventList.set(eventName, [{ callback: callback, scope: scope }]);
    }
  }
...
function createSprite(image) {
  ...
  function resize(width, height) {
    ...
    contextTmp.drawImage(buffer, 0, 0, buffer.width, buffer.height, 0, 0, width, height);
...
var _keyboardstate = __webpack_require__(359);

var _keyboardstate2 = _interopRequireDefault(_keyboardstate);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function setupKeyboard(entities) {
...
exports.snapCollider = snapCollider;
exports.colliderBarre = colliderBarre;
exports.colliderView = colliderView;
function drawGrid(conf, _ref) {
  var width = _ref.width,
      height = _ref.height;
  ...
  function init(self) {
    ...
    var middle = Math.round(conf.resolution / 2);
    ...
    for (var i = 0; i < _width; i += conf.resolution) {
    ...
    for (var j = 0; j < _height; j += conf.resolution) {
...
function snapCollider(entities) {
  ...
  return function (context, cumulate) {
    ...
    entities.map(function (entity) {
      if (entity.mover) {
        var snapPosList = entity.mover.snapPos(entity);

        snapPosList.map(function (snapPos) {

          context.beginPath();
          context.rect(snapPos.x, snapPos.y, entity.grid, entity.grid);
...
function colliderBarre(entities) {

  var barres = entities.filter(function (entity) {
  ...
  return function (context, cumulate) {
    ...
    barres.map(function (entity) {

      entity.segment.map(function (_ref2) {
        var point1 = _ref2.point1,
            point2 = _ref2.point2;
...
function colliderView(entities) {
  ...
  return function (context, cumulate) {
    ...
    entities.map(function (entity) {
      ...
      context.beginPath();
      context.lineWidth = 1;
      context.rect(entity.bound.left, entity.bound.top, entity.bound.width, entity.bound.height);
      ...
      context.arc(entity.pos.x, entity.pos.y, 2, 0, 2 * Math.PI, false);
      ...
      context.arc(entity.pos.x + entity.offset.x, entity.pos.y + entity.offset.y, 2, 0, 2 * Math.PI, false);
...
window.GameCtrl = function () {
    ...
    var self = {
        ...
        displaySoshHeader: displaySoshHeader
    },
        instance = false,
    ...
    function _init() {
        ...
        instance.on('level.ready', function () {
            RouterCtrl.renderScore(0);
        });

        instance.on('level.died', function () {
            RouterCtrl.displayPageByName(screen);
        });

        instance.on('level.tick', function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
                iMax = _ref2[0],
                iRatetimeElapsed = _ref2[1];
        ...
        instance.on('level.collide', function (_ref3) {
        ...
        instance.on('level.palierPasted', function (_ref5) {
        ...
        instance.on('level.timeout', function () {
            RouterCtrl.displayPageByName(screen);
        });

        instance.on('level.allCollide', function () {
            RouterCtrl.displayPageByName(screen);
        });

        instance.on('level.sending', function (oResponse) {
...
window.FormCtrl = function () {
    ...
    var self = {
        ...
        _hideErrorPopUp: _hideErrorPopUp,
...
window.RouterCtrl = function () {
    ...
    var self = {
        ...
        displayPageByName: displayPageByName,
